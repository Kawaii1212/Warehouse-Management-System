...
@WebServlet(name = "SAChangePassWord", urlPatterns = {"/SAChangePassWord"})
public class SAChangePassWordController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/sale/SAChangePassWord.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (updated) {
            ...
            currentUser.setPasswordHash(hashSHA256(newPassword)); // ✅ Lưu hash mới
