...
@WebServlet(name = "SAInformationController", urlPatterns = {"/SAInformation"})
public class SAInformationController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/sale/SAInformation.jsp").forward(request, response);
    }
