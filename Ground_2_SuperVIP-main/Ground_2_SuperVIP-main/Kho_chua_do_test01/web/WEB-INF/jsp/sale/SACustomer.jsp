                ...
                <c:if test="${totalPages > 1}">
                    <c:forEach var="p" begin="1" end="${totalPages}">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a class="page-btn" href="<c:url value='sa-customer'>
                                       ...
                                       <c:if test='${not empty param.minSpent}'>
                                           <c:param name='minSpent' value='${param.minSpent}'/>
                                       </c:if>
                                       <c:if test='${not empty param.maxSpent}'>
                                           <c:param name='maxSpent' value='${param.maxSpent}'/>
                                       </c:if>
                                       <c:if test='${not empty param.branchId}'>
                                           <c:param name='branchId' value='${param.branchId}'/>
                                       </c:if>
                                   </c:url>">
                                    ${p}
                                </a>
