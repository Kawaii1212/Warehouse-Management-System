    ...
    <body>
        ...
        <div class="staff-edit-container">
            ...
            <form action="EditUser" method="post" id="editUserForm">
                <c:set var="viewOnly" value="${sessionScope.currentUser.roleId == 1}" />

                <!-- fieldset khóa toàn bộ form nếu viewOnly = true -->
                <fieldset ${viewOnly ? "disabled" : ""}>
