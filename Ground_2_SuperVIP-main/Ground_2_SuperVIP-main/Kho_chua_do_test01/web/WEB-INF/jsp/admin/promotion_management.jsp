...
<body>
                ...
                <div class="col-md-12" style="margin-top: 60px;">
                    <div class="promotion-wrapper">
                        ...
                        <div class="alert alert-error">
                            ...
                            ❌ <%= errorMessage %>
                            <% } else if ("empty_fields".equals(error) || "empty_promo_name".equals(error)) { %>
                            ...
                            ❌ Cập nhật khuyến mãi thất bại! Vui lòng kiểm tra lại dữ liệu hoặc thử lại sau.
                            <% } else if ("delete_failed".equals(error)) { %>
                            ❌ Xóa khuyến mãi thất bại!
                            <% } else if ("unknown_action".equals(error)) { %>
                            ⚠️ Hành động không được nhận diện!
                            ...
                            ⚠️ Dữ liệu không hợp lệ!
                            <% } else { %>
                            ❌ Thao tác thất bại! Lỗi: <%= error %>
                            <% } %>
                        </div>
                        <% } %>
                        ...
                        <div class="promotion-header">
                            ...
                            <div class="header-actions">
                                ...
                                <c:if test="${sessionScope.currentUser.roleId == 0}">
                                    <!-- Chỉ hiển thị button "Thêm mới" cho role 0 (Admin) -->
                                ...
                                <tbody>
                                    ...
                                    <tr data-status="<%= promo.getStatus() %>" 
                                        ...
                                        <td class="action-buttons">
                                            ...
                                            <c:if test="${sessionScope.currentUser.roleId == 0}">
                                                <!-- Chỉ hiển thị button Edit và Delete cho role 0 (Admin) -->
    ...
    <div id="promoModal" class="modal">
        <div class="modal-content-large">
            ...
            <form id="promoForm" method="post" action="<%= request.getContextPath() %>/Promotion" onsubmit="return validateForm()">
