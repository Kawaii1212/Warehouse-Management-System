                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <%
                                ...
                                // Get original ResponseStatus (not lowercase) for comparison
                                String originalStatus = (movement != null && movement.getResponseStatus() != null) 
                                    ? movement.getResponseStatus() : "";
                                
                                // Check both English and Vietnamese status
                                if ("completed".equalsIgnoreCase(movementStatus) || "Hoàn thành".equalsIgnoreCase(originalStatus)) { 
                                    statusText = "Hoàn thành"; 
                                    icon = "fa-check-circle"; 
                                    statusClass = "completed";
                                } 
                                else if ("processing".equalsIgnoreCase(movementStatus) || "Đang xử lý".equalsIgnoreCase(originalStatus)) { 
                                    statusText = "Đang xử lý"; 
                                    icon = "fa-clock"; 
                                    statusClass = "processing";
                                }
                                else if ("Đang vận chuyển".equalsIgnoreCase(originalStatus)) {
                                    statusText = "Đang vận chuyển";
                                    icon = "fa-truck";
                                    statusClass = "processing";
                                }
                                else if ("Đã hủy".equalsIgnoreCase(originalStatus)) {
                                    statusText = "Đã hủy";
